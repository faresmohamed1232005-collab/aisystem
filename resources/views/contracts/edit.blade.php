...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-2xl shadow-sm p-6">
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <h2 class="text-xl font-bold text-gray-800">تعديل العقد — {{ $contract->name }}</h2>
        </div>
        ...
        <form action="{{ route('contracts.update', $contract) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            @csrf @method('PUT')
